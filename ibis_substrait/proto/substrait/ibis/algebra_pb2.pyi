...
class Rel(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal['rel_type', b'rel_type']) -> typing.Optional[typing_extensions.Literal['read', 'filter', 'fetch', 'aggregate', 'sort', 'join', 'project', 'set', 'extension_single', 'extension_multi', 'extension_leaf', 'cross', 'hash_join', 'merge_join']]:
        ...
global___Rel = Rel
...
class HashJoinRel(google.protobuf.message.Message):
    ...
    def __init__(self, *, common: typing.Optional[global___RelCommon]=..., left: typing.Optional[global___Rel]=..., right: typing.Optional[global___Rel]=..., left_keys: typing.Optional[typing.Iterable[global___Expression.FieldReference]]=..., right_keys: typing.Optional[typing.Iterable[global___Expression.FieldReference]]=..., post_join_filter: typing.Optional[global___Expression]=..., type: global___HashJoinRel.JoinType.ValueType=..., advanced_extension: typing.Optional[substrait.ibis.extensions.extensions_pb2.AdvancedExtension]=...) -> None:
        ...
...
class MergeJoinRel(google.protobuf.message.Message):
    ...
    def __init__(self, *, common: typing.Optional[global___RelCommon]=..., left: typing.Optional[global___Rel]=..., right: typing.Optional[global___Rel]=..., left_keys: typing.Optional[typing.Iterable[global___Expression.FieldReference]]=..., right_keys: typing.Optional[typing.Iterable[global___Expression.FieldReference]]=..., post_join_filter: typing.Optional[global___Expression]=..., type: global___MergeJoinRel.JoinType.ValueType=..., advanced_extension: typing.Optional[substrait.ibis.extensions.extensions_pb2.AdvancedExtension]=...) -> None:
        ...
...
class FunctionArgument(google.protobuf.message.Message):
    ...
    def __init__(self, *, enum: typing.Text=..., type: typing.Optional[substrait.ibis.type_pb2.Type]=..., value: typing.Optional[global___Expression]=...) -> None:
        ...
...
class FunctionOption(google.protobuf.message.Message):
    ...
    @property
    def preference(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self, *, name: typing.Text=..., preference: typing.Optional[typing.Iterable[typing.Text]]=...) -> None:
        ...
...
class Expression(google.protobuf.message.Message):
    ...
    class Nested(google.protobuf.message.Message):
        ...
        class Map(google.protobuf.message.Message):
            ...
            class KeyValue(google.protobuf.message.Message):
                ...
                def __init__(self, *, key: typing.Optional[global___Expression]=..., value: typing.Optional[global___Expression]=...) -> None:
                    ...
            ...
            def __init__(self, *, key_values: typing.Optional[typing.Iterable[global___Expression.Nested.Map.KeyValue]]=...) -> None:
                ...
        ...
        class List(google.protobuf.message.Message):
            ...
            def __init__(self, *, values: typing.Optional[typing.Iterable[global___Expression]]=...) -> None:
                ...
        ...
        def __init__(self, *, nullable: builtins.bool=..., type_variation_reference: builtins.int=..., struct: typing.Optional[global___Expression.Nested.Struct]=..., list: typing.Optional[global___Expression.Nested.List]=..., map: typing.Optional[global___Expression.Nested.Map]=...) -> None:
            ...
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal['nested_type', b'nested_type']) -> typing.Optional[typing_extensions.Literal['struct', 'list', 'map']]:
            ...
    ...
    class ScalarFunction(google.protobuf.message.Message):
        ...
        def __init__(self, *, function_reference: builtins.int=..., arguments: typing.Optional[typing.Iterable[global___FunctionArgument]]=..., options: typing.Optional[typing.Iterable[global___FunctionOption]]=..., output_type: typing.Optional[substrait.ibis.type_pb2.Type]=..., args: typing.Optional[typing.Iterable[global___Expression]]=...) -> None:
            ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal['rex_type', b'rex_type']) -> typing.Optional[typing_extensions.Literal['literal', 'selection', 'scalar_function', 'window_function', 'if_then', 'switch_expression', 'singular_or_list', 'multi_or_list', 'cast', 'subquery', 'nested', 'enum']]:
        ...
